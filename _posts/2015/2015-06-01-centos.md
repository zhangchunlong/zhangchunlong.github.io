...
*   首先从http://isoredirect.centos.org/centos/7/isos/x86_64/CentOS-7-x86_64- Minimal-1503-01.iso 下载iso镜像
...
*   一般网卡可以使用CentOS官方教程<http://wiki.centos.org/HowTos/Laptops/Wireless/Broadcom?action=show>进行了安装.但是对于BCM43142 802.11b/g/n，该教材不奏效。  
